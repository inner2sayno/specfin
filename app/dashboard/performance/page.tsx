...
export default function Page() {
  return (
    <div className="min-h-[calc(100vh-120px)] bg-[#030812] flex flex-col items-center justify-center px-6 py-20">
      ...
      <h1 className="text-[24px] font-bold text-white mb-3 text-center">Portfolio Performance</h1>
      <p className="text-[14px] text-[#9fb6d0] text-center max-w-md mb-8 leading-relaxed">No performance data yet. Your portfolio performance, returns, and benchmarks will appear here once you have active investments.</p>
